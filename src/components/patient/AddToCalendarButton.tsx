...
export function AddToCalendarButton({ event }: AddToCalendarButtonProps) {
  ...
  const btnClass =
    "flex items-center gap-1 rounded-full border border-blue-500/40 px-3 py-1.5 text-xs font-semibold text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-950/40";

  // iOS → doğrudan .ics indir, Apple Takvim açar
  if (platform === "ios") {
    return (
      <button
        type="button"
  ...
  // Android → doğrudan Google Takvim
  if (platform === "android") {
    return (
      <a
  ...
  // Desktop → dropdown (Google veya .ics)
  return (
