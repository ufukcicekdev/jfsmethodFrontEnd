...
export function NotificationBell() {
  ...
  const handleMarkAllRead = async () => {
    ...
    try {
      await api.admin.markAllNotificationsRead(token);
      setNotifications((items) =>
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="fixed inset-x-4 top-[4.5rem] z-50 overflow-hidden rounded-2xl border border-white/30 bg-white/95 shadow-xl shadow-slate-300/30 backdrop-blur-xl sm:absolute sm:inset-x-auto sm:right-0 sm:top-auto sm:mt-2 sm:w-[min(100vw-2rem,380px)] dark:border-slate-600/50 dark:bg-slate-900/95 dark:shadow-black/40">
