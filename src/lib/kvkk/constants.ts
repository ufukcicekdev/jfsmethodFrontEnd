...
export const COOKIE_CONSENT_KEY = "jfs_cookie_consent";
...
6698 sayılı Kişisel Verilerin Korunması Kanunu kapsamında, özel nitelikli kişisel veri niteliğindeki sağlık verilerimin (boy, kilo, kilo geçmişi, fizyoterapi notları, randevu ve tedavi bilgileri) JFS Method platformunda;

• Kişiselleştirilmiş dijital sağlık ikizi oluşturulması,
• Fizyoterapi tedavi sürecimin takibi,
